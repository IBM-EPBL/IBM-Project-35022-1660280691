    ...
    def predict_heart_disease():
        try:
            ...
            if is_valid_user:
                ...
                result = model.predict([[params['age'],params['sex'],params['chest_pain_type'],params['bp'],params['cholestrol'],params['fbs_over_120'],params['ekg_results'],params['max_hr'],params['exercise_angina'],params['st_depression'],params['slope_of_st'],params['number_of_vessels_fluro'],params['thallium']]])
