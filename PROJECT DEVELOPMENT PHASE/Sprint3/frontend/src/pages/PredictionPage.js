...
function PredictionPage() {
  ...
  function predictResult(event) {
    ...
    if (age && sex && chestPainType && bp && cholestrol && fbs && ekg && maxHr && angina && stDepression && slopeOfSt && fluro && thallium) {
  ...
  return (
    <div className="main-container">
      <form className="main-form" onSubmit={predictResult}>
        ...
        <div className="form-input">
          <p>Cholestrol</p>
          <input type="number" name="cholestrol" id="text-input" value={cholestrol} onChange={(e) => setCholestrol(e.target.value)} />
        </div>
        <div className="form-input">
